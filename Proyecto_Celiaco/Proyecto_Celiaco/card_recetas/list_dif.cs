...
namespace Proyecto_Celiaco.card_recetas
{
    public class list_dif
    {
        ...
        public void GenerarTarjetas()
        {
            ...
            lstinst.Add(new Dificultad() { dif_id = 2, tipo = "Intermedio", color_dif = StyleKit.receta_color.mediano, descripcion = "Recetas de 1 hora aproximadamente horas para disfrutar y compartir con familia y amigos!" });
            lstinst.Add(new Dificultad() { dif_id = 3, tipo = "Dificil", color_dif = StyleKit.receta_color.dificil, descripcion = "Verdaderos desafios de 1 hora o mas con exquisitos resultados!" });
